...
using BookLibrary.aspnetcore.UI.Features.Home;
...
namespace BookLibrary.aspnetcore.UI.Features.Account
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly ISignInManagerService<ApplicationUser> _signInManager;
        private readonly IEmailSender _emailSender;
        private readonly ILogger _logger;

        public AccountController(
            IUserManagerService<ApplicationUser> userManager,
            ISignInManagerService<ApplicationUser> signInManager,
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { Email = model.Email, Password = model.Password, RememberMe = model.RememberMe, LockoutOnFailure = false };
